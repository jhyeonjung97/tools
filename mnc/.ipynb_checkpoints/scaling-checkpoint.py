...
def scaling(dG1, dG2, ads1, ads2, df): #, xmin, xmax, ymin, ymax):
    ...
    plt.plot(xx, line(xx), label=fr'$\Delta$G$_{{\sf {ads2}}}$ (trend)', linewidth=0.9, linestyle='-', color='black', zorder=2)
    if ads1 == 'OH' and ads2 == 'O':
        plt.plot(xx, 2.00*xx-0.75, linewidth=0.9, linestyle='--', color='lightgray', zorder=0)
        plt.plot(xx, 1.64*xx+0.95, linewidth=0.9, linestyle='--', color='darkgray', zorder=1)
        ...
        plt.plot(xx, 1.06*xx+3.16, linewidth=0.9, linestyle='--', color='lightgray', zorder=0)
        plt.plot(xx, 1.05*xx+3.01, linewidth=0.9, linestyle='--', color='darkgray', zorder=1)
