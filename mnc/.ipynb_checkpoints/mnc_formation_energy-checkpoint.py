            ...
            for spin in spins.keys():
                ...
                for path in matching_paths:
                    ...
                    for i, dz in enumerate(dzs):
                        ...
                        # atoms_O_path = os.path.join(path, f'{i}_/1_O', 'final_with_calculator.json')
                        # atoms_OH_path = os.path.join(path, f'{i}_/2_OH', 'final_with_calculator.json')
...
def plot_smooth_line(x, y, color, label):
    try:
        ...
        plt.scatter(x, y, color=color, edgecolors=color, facecolors='blue', marker='o', label='_nolegend_', zorder=2)
