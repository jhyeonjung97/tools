...
cathub="${mnc}/JungTunability2025/${vasp_pbe}"
...
for dir in ${mnc}/pourbaix/*_*/*/most_stable; do
    ...
    if [[ "$ads_upper" == "MH" ]]; then
        site=${site1}; dual=''; rxn="0.5H2gas_star__Hstar"
    elif [[ "$ads_upper" == "NH" ]]; then
        site=${site2}; dual=''; rxn="0.5H2gas_star__Hstar"
    elif [[ "$ads_upper" == "O" ]]; then
        site=${site1}; dual=''; rxn="H2Ogas_-1.0H2gas_star__Ostar"
    elif [[ "$ads_upper" == "OH" ]]; then
        site=${site1}; dual=''; rxn="H2Ogas_-0.5H2gas_star__OHstar"
    elif [[ "$ads_upper" == "OOH" ]]; then
        site=${site1}; dual=''; rxn="2.0H2Ogas_-1.5H2gas_star__OOHstar"
    elif [[ "$ads_upper" == "OO" ]]; then
        site=${site1}; dual='_adjacent'; rxn="2.0H2Ogas_-2.0H2gas_star__OstarOstar"
    elif [[ "$ads_upper" == "OHO" ]]; then
        site=${site1}; dual='_adjacent'; rxn="2.0H2Ogas_-1.5H2gas_star__OHstarOstar"
    elif [[ "$ads_upper" == "OHOH" ]]; then
        site=${site1}; dual='_adjacent'; rxn="2.0H2Ogas_-1.0H2gas_star__OHstarOHstar"
    elif [[ "$ads_upper" == "OOHO" ]] || [[ "$ads_upper" == "OOOH" ]]; then
        site=${site1}; dual='_adjacent'; rxn="3.0H2Ogas_-2.5H2gas_star__OOHstarOstar"
    elif [[ "$ads_upper" == "OOHOH" ]] || [[ "$ads_upper" == "OHOOH" ]]; then
        site=${site1}; dual='_adjacent'; rxn="3.0H2Ogas_-2.0H2gas_star__OOHstarOHstar"
    elif [[ "$ads_upper" == "OOHOOH" ]]; then
        site=${site1}; dual='_adjacent'; rxn="4.0H2Ogas_-3.0H2gas_star__OOHstarOOHstar"
    elif [[ "$ads_upper" == "O-O" ]]; then
        site=${site1}; dual='_antipodal'; rxn="2.0H2Ogas_-2.0H2gas_star__OstarOstar"
    elif [[ "$ads_upper" == "OH-O" ]] || [[ "$ads_upper" == "O-OH" ]]; then
        site=${site1}; dual='_antipodal'; rxn="2.0H2Ogas_-1.5H2gas_star__OHstarOstar"
    elif [[ "$ads_upper" == "OH-OH" ]]; then
        site=${site1}; dual='_antipodal'; rxn="2.0H2Ogas_-1.0H2gas_star__OHstarOHstar"
    elif [[ "$ads_upper" == "OOH-O" ]] || [[ "$ads_upper" == "O-OOH" ]]; then
        site=${site1}; dual='_antipodal'; rxn="3.0H2Ogas_-2.5H2gas_star__OOHstarOstar"
    elif [[ "$ads_upper" == "OOH-OH" ]] || [[ "$ads_upper" == "OH-OOH" ]]; then
        site=${site1}; dual='_antipodal'; rxn="3.0H2Ogas_-2.0H2gas_star__OOHstarOHstar"
    elif [[ "$ads_upper" == "OOH-OOH" ]]; then
        site=${site1}; dual='_antipodal'; rxn="4.0H2Ogas_-3.0H2gas_star__OOHstarOOHstar"
    else
        rxn=''
    fi
