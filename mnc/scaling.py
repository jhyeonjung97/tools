...
def scaling(dG1, dG2, ads1, ads2, df): #, xmin, xmax, ymin, ymax):
    ...
    if ads1 == 'OH' and ads2 == 'O':
        plt.plot(xx, 2.00*xx-0.75, linestyle='--', color='lightgrey', zorder=0)
        plt.plot(xx, 1.64*xx+0.95, linestyle='--', color='silver', zorder=0)
        plt.text(0.35, 0.10, 'y = 2.00x - 0.75 (metal)', transform=plt.gca().transAxes, fontsize=10, color='lightgrey')
        plt.text(0.35, 0.15, 'y = 1.64x + 0.95 (oxide)', transform=plt.gca().transAxes, fontsize=10, color='silver')
    elif ads1 == 'OH' and ads2 == 'OOH':
        plt.plot(xx, 1.06*xx+3.16, linestyle='--', color='lightgrey', zorder=0)
        plt.plot(xx, 1.05*xx+3.01, linestyle='--', color='silver', zorder=0)
        plt.text(0.35, 0.10, 'y = 1.06x + 3.16 (metal)', transform=plt.gca().transAxes, fontsize=10, color='lightgrey')
        plt.text(0.35, 0.15, 'y = 1.05x + 3.01 (oxide)', transform=plt.gca().transAxes, fontsize=10, color='silver')
