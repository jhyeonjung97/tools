...
def scaling(dG1, dG2, ads1, ads2, df): #, xmin, xmax, ymin, ymax):
    ...
    if ads1 == 'OH' and ads2 == 'O':
        ...
        plt.text(0.12, 0.05, 'y = 1.49x + 1.21 ((oxi)(hydro)oxides)', transform=plt.gca().transAxes, fontsize=10, color='lightblue')
        ...
        plt.text(0.12, 0.05, 'y = 0.84x + 3.14 ((oxi)(hydro)oxides)', transform=plt.gca().transAxes, fontsize=10, color='lightblue')
    ...
    plt.text(0.32, 0.11, equation_with_r2, transform=plt.gca().transAxes, fontsize=10, color='black')
