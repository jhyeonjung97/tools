...
def scaling(dG1, dG2, ads1, ads2, df): #, xmin, xmax, ymin, ymax):
    ...
    if ads1 == 'OH' and ads2 == 'O':
        ...
        plt.text(0.33, 0.23, 'y = 2.00x - 0.75 (metal)', transform=plt.gca().transAxes, fontsize=10, color='lightgray')
        plt.text(0.33, 0.17, 'y = 1.64x + 0.95 (oxide)', transform=plt.gca().transAxes, fontsize=10, color='darkgray')
        plt.text(0.14, 0.05, 'y = 1.49x + 1.21 ((oxi)(hydro)oxides)', transform=plt.gca().transAxes, fontsize=10, color='lightblue')
        ...
        plt.text(0.33, 0.23, 'y = 1.06x + 3.16 (metal)', transform=plt.gca().transAxes, fontsize=10, color='lightgray')
        plt.text(0.33, 0.17, 'y = 1.05x + 3.01 (oxide)', transform=plt.gca().transAxes, fontsize=10, color='darkgray')
        plt.text(0.14, 0.05, 'y = 0.84x + 3.14 ((oxi)(hydro)oxides)', transform=plt.gca().transAxes, fontsize=10, color='lightblue')
    ...
    plt.text(0.33, 0.11, equation_with_r2, transform=plt.gca().transAxes, fontsize=10, color='black')
