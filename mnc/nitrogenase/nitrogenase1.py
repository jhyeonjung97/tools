...
def plot_pourbaix(entries, png_name):
    ...
    name_mapping = {
        'Fe7MoH8C2S10NO2(s)': r'E$_{0}$',
        'Fe7MoH9C2S10NO2(s)': r'E$_{1}$',
        'Fe7MoH10C2S10NO2(s)': r'E$_{2}$',
        'Fe7MoH11C2S10NO2(s)': r'E$_{3}$',
        'Fe7MoH12C2S10NO2(s)': r'E$_{4}$',
        'Fe7MoH10C2S9NO2(s)': r'E$_{v}$',
    }
    ...
    if 'cluster' in png_name:
        omit_parts = ['Fe(s)', 'Mo(s)', 'N2(s)', 'C(s)' , 'S(s)', ' ', '+']
        for text in ax.texts:
            old_name = text.get_text()
            new_name = old_name
...
def main():
    ...
    plot_pourbaix(all_entries, f'{png_name}_cluster1.png')
