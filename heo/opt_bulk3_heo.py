...
if path.exists('restart.json'):
    ...
    atoms[8].magmom = spin_states_plus_4.get(atoms[8].symbol)
    atoms[9].magmom = -spin_states_plus_4.get(atoms[9].symbol)
    atoms[10].magmom = -spin_states_plus_4.get(atoms[10].symbol)
    atoms[11].magmom = spin_states_plus_4.get(atoms[11].symbol)
    atoms[12].magmom = -spin_states_plus_4.get(atoms[12].symbol)
    atoms[13].magmom = spin_states_plus_4.get(atoms[13].symbol)
    atoms[14].magmom = spin_states_plus_4.get(atoms[14].symbol)
    atoms[15].magmom = -spin_states_plus_4.get(atoms[15].symbol)
else:
