...
for dir in /Users/hailey/Desktop/3_V_bulk/*_*_A*/*/
do
    cd $dir
...
cd /Users/hailey/Desktop/3_V_bulk/figures
python ~/bin/tools/tetra/concat.py -o energy --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_energy.tsv
python ~/bin/tools/tetra/concat.py -o norm_energy --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_norm_energy.tsv
python ~/bin/tools/tetra/concat.py -o norm_formation --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_norm_formation.tsv
python ~/bin/tools/tetra/concat.py -o norm_cohesive --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_norm_cohesive.tsv
python ~/bin/tools/tetra/concat.py -o ICOHP --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_ICOHP.tsv
python ~/bin/tools/tetra/concat.py -o norm_ICOHP --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_norm_ICOHP.tsv
python ~/bin/tools/tetra/concat.py -o ICOBI --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_ICOBI.tsv
python ~/bin/tools/tetra/concat.py -o norm_ICOBI --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_norm_ICOBI.tsv
python ~/bin/tools/tetra/concat.py -o bond --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_bond.tsv
python ~/bin/tools/tetra/concat.py -o norm_volume --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_norm_volume.tsv
python ~/bin/tools/tetra/concat.py -o chg --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_chg.tsv
python ~/bin/tools/tetra/concat.py -o mag --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_mag_M.tsv
python ~/bin/tools/tetra/concat.py -o norm_MadelungL --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_norm_Madelung_L.tsv
python ~/bin/tools/tetra/concat.py -o GrossPopulationL --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_GP_L_M.tsv
python ~/bin/tools/tetra/concat.py -o redoxP --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_redoxP.tsv
python ~/bin/tools/tetra/concat.py -o redoxP_clean --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_redoxP_clean.tsv
...
cd /Users/hailey/Desktop/3_V_bulk/figures/rel8
...
for i in "${!keys[@]}"; do
    ...
    /Users/hailey/Desktop/3_V_bulk/8_Tetrahedral_AQ/"$file" \
    /Users/hailey/Desktop/3_V_bulk/9_SquarePlanar_AU/"$file"
done
keys=("element" "row")
...
cd /Users/hailey/Desktop/3_V_bulk/figures/rel9
...
-y concat_fusion_heat.tsv \
-z concat_sublimation_heat.tsv
python ~/bin/tools/tetra/concat.py -o coord --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_coord.tsv
python ~/bin/tools/tetra/concat.py -o element --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_element.tsv
python ~/bin/tools/tetra/concat.py -o row --X /Users/hailey/Desktop/3_V_bulk/*_*_*/merged_row.tsv
