...
def main():
    ...
    parser.add_argument('-o', '--oxygen', type=float, default=-4.658724749999999, help='Oxygen chemical potential (eV/atom)')
    ...
    for row in rows:
        ...
        for i, element in enumerate(elements[row]):
            ...
            plt.scatter(1/8, formation_energy_mruo2, marker='D', edgecolor='black', facecolor='orange')
            plt.text(1/8, formation_energy_mruo2-0.04, f'{element}-RuO$_2$\n(rutile)', ha='center', va='top', linespacing=0.8)
            ...
            if element == 'Re':
                ...
                plt.text(1.0, formation_energy_reo2+0.02, f'ReO$_2$\n(ortho-\nrhombic)', ha='center', va='bottom', linespacing=0.8)
                ...
                plt.text(1.0, formation_energy_re2o7+0.03, r'Re$_2$O$_7$', ha='center', va='bottom')
