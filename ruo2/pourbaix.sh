...
python ~/bin/HybridPB/HybridPourbaix.py --hybrid --Umin -2 --Umax 2 --cmin 0.1 --cmax 0.6

--cmap-2d RdYlBu --cmin-2d 0.3 --cmax-2d 0.8 --cgap-2d 0.0 --cmin 0.0 --cmax 0.3

python ~/bin/HybridPB/HybridPourbaix.py --hybrid --no-bulk --colors-bulk white whitesmoke white \
...
python ~/bin/HybridPB/HybridPourbaix.py \
...
python ~/bin/HybridPB/HybridPourbaix.py --hybrid \
--Umin -0.5 --Umax 2.5 --Gmin -15 --Gmax 15 \
