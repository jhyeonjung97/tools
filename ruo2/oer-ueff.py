...
def calculate_oer_energies():
    ...
    # Path 2.0: OOH-Otop에서 1_O_V → 2_O_OH → 3_O_O → 5_OH_OO
    print("\n=== Path 2.0: OOH-Otop (O_V → O_OH → O_O → OH_OO) ===")
    try:
        oer_path = root_path / "5_OER" / "1_OOH-Otop2"
        ...
        if all(e is not None for e in [energy_o_v, energy_o_oh, energy_o_o, energy_oh_oo]):
            ...
            all_paths['Path2.0'] = [step1, step2, step3, step4]
            print(f"Step1: {step1:.3f} eV, Step2: {step2:.3f} eV, Step3: {step3:.3f} eV, Step4: {step4:.3f} eV")
        else:
            print("Path 2.0: Failed to load some energies")
    except Exception as e:
        print(f"Path 2.0: Error - {e}")

    # Path 2.2: OOH-Otop에서 1_O_V → 2_O_OH → 3_O_O → 5_OH_OO
    print("\n=== Path 2.2: OOH-Otop (O_V → O_OH → O_O → OH_OO) ===")
    try:
        ...
        if all(e is not None for e in [energy_o_v, energy_o_oh, energy_o_o, energy_oh_oo]):
            ...
            all_paths['Path2.2'] = [step1, step2, step3, step4]
            print(f"Step1: {step1:.3f} eV, Step2: {step2:.3f} eV, Step3: {step3:.3f} eV, Step4: {step4:.3f} eV")
        else:
            print("Path 2.2: Failed to load some energies")
    except Exception as e:
    ...
    try:
        ...
        if all(e is not None for e in [energy_o_v, energy_o_oh, energy_o_o, energy_oh_oo]):
            ...
            all_paths['Path2.4'] = [step1, step2, step3, step4]
            print(f"Step1: {step1:.3f} eV, Step2: {step2:.3f} eV, Step3: {step3:.3f} eV, Step4: {step4:.3f} eV")
        else:
            print("Path 2.4: Failed to load some energies")
    except Exception as e:
    ...
    try:
        oer_path = root_path / "1_RuO2"
        energy_o_v = get_energy_from_json(oer_path / "3_V_O" / "3_" / "final_with_calculator.json")
        ...
        if all(e is not None for e in [energy_o_v, energy_o_oh, energy_o_o, energy_oh_oo]):
            ...
            all_paths['Path2.6'] = [step1, step2, step3, step4]
            print(f"Step1: {step1:.3f} eV, Step2: {step2:.3f} eV, Step3: {step3:.3f} eV, Step4: {step4:.3f} eV")
        else:
            print("Path 2.6: Failed to load some energies")
    except Exception as e:
        print(f"Path 2.6: Error - {e}")

    # Path 2.8: OOH-Otop에서 1_O_V → 2_O_OH → 3_O_O → 5_OH_OO
    print("\n=== Path 2.8: OOH-Otop (O_V → O_OH → O_O → OH_OO) ===")
    try:
        oer_path = root_path / "1_RuO2"
        energy_o_v = get_energy_from_json(oer_path / "3_V_O" / "3_" / "final_with_calculator.json")
        energy_o_oh = get_energy_from_json(oer_path / "4_O_OH" / "3_" / "final_with_calculator.json")
        ...
        if all(e is not None for e in [energy_o_v, energy_o_oh, energy_o_o, energy_oh_oo]):
            ...
            all_paths['Path2.8'] = [step1, step2, step3, step4]
            print(f"Step1: {step1:.3f} eV, Step2: {step2:.3f} eV, Step3: {step3:.3f} eV, Step4: {step4:.3f} eV")
        else:
            print("Path 2.8: Failed to load some energies")
    except Exception as e:
        print(f"Path 2.8: Error - {e}")

    # Path 3.0: OOH-Otop에서 1_O_V → 2_O_OH → 3_O_O → 5_OH_OO
    print("\n=== Path 3.0: OOH-Otop (O_V → O_OH → O_O → OH_OO) ===")
    try:
        oer_path = root_path / "5_OER" / "5_OOH-Otop3"
        energy_o_v = get_energy_from_json(oer_path / "1_O_V" / "final_with_calculator.json")
        energy_o_oh = get_energy_from_json(oer_path / "2_O_OH" / "final_with_calculator.json")
        energy_o_o = get_energy_from_json(oer_path / "3_O_O" / "final_with_calculator.json")
        energy_oh_oo = get_energy_from_json(oer_path / "5_OH_OO" / "final_with_calculator.json")
        ...
        if all(e is not None for e in [energy_o_v, energy_o_oh, energy_o_o, energy_oh_oo]):
            ...
            all_paths['Path3.0'] = [step1, step2, step3, step4]
            print(f"Step1: {step1:.3f} eV, Step2: {step2:.3f} eV, Step3: {step3:.3f} eV, Step4: {step4:.3f} eV")
        else:
            print("Path 3.0: Failed to load some energies")
    except Exception as e:
        print(f"Path 3.0: Error - {e}")
