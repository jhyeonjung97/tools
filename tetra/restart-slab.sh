...
for coord in 1_Tetrahedral_WZ 2_Tetrahedral_ZB 3_SquarePlanar_TN 4_SquarePlanar_PD 5_SquarePlanar_NB 6_Octahedral_RS 7_Pyramidal_LT 8_Tetrahedral_WZ 9_Tetrahedral_ZB
# for coord in 5_SquarePlanar_NB 6_Octahedral_RS 7_Pyramidal_LT 9_Tetrahedral_ZB
do
    for row in 3d 4d 5d
    do
        for ads in o oh
...
for coord in 1_Tetrahedral_WZ 2_Tetrahedral_ZB 3_SquarePlanar_TN 5_SquarePlanar_NB 6_Octahedral_RS 9_Tetrahedral_ZB
do
    for row in 3d 4d 5d
    do
        for ads in o oh
