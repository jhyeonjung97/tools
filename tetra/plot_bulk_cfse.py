...
columns_data = [
    ...
    {'column': '-ICOHPo', 'png_name': 'icohp_normalized',    'ylabel': 'normalized -ICOHP per Metal (eV)'},
    {'column': 'ICOBIo',  'png_name': 'icobi_normalized',    'ylabel': 'normalized ICOBI per Metal'},
    {'column': '-ICOOPo', 'png_name': 'icoop_normalized',    'ylabel': 'normalized -ICOOP per Metal (eV)'},
