...
if [[ ${here} == 'slac' ]]; then
    ...
    # python ~/bin/tools/tetra/tsv2.py -l  3d 4d 5d -x "Metal (MO)" -y "Total energy (eV)" -o norm_energy *d/energy_norm_energy.tsv
    ...
    # sed -i -e 's/CN/TN/g' 3_Pyramidal_LT/merged_coord.tsv
    # sed -i -e 's/CN/PD/g' 4_Square_Planar_TN/merged_coord.tsv
