...
coords = [
    ...
    {'coord_dir': '2_Tetrahedral_ZB',  'P': np.array([[ 0, 1,-1],[-3, 1, 1],[-1, 1, 1]]), 'n_layers': 4, 'm_fix': 8},
    {'coord_dir': '3_SquarePlanar_TN', 'P': np.array([[ 1, 1, 0],[-1, 1, 2],[ 1,-2, 1]]), 'n_layers': 2, 'm_fix': 8},
    {'coord_dir': '4_SquarePlanar_PD', 'P': np.array([[ 1, 0, 0],[ 0, 1, 1],[ 0,-3, 1]]), 'n_layers': 2, 'm_fix': 8},
    {'coord_dir': '5_SquarePlanar_NB', 'P': np.array([[ 1,-1,-1],[ 1, 1,-1],[ 1,-1, 1]]), 'n_layers': 2, 'm_fix': 6},
    {'coord_dir': '6_Octahedral_RS',   'P': np.array([[-1,-1, 3],[ 3,-1,-1],[-1, 3,-1]]), 'n_layers': 2, 'm_fix': 8},
    {'coord_dir': '7_Pyramidal_LT',    'P': np.array([[ 1, 0, 0],[ 0, 1, 0],[ 0, 0, 1]]), 'n_layers': 4, 'm_fix': 4},
]
