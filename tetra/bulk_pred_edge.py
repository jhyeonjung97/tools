...
def main():
    ...
    # NumPy 배열로 변환
    X_pred_scaled_values = X_pred_scaled.values
    
    # 예측 수행
    y_pred = model.predict(X_pred_scaled_values)
    std_pred = get_prediction_std(model, X_pred_scaled_values, model_type=args.model)
