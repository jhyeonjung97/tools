...
# 데이터 파일 경로 설정
data_path = '/Users/jiuy97/Desktop/7_V_bulk/figures/bulk_data_total.csv'
save_path = '/Users/jiuy97/Desktop/7_V_bulk/figures'

# 데이터 읽기
df = pd.read_csv(data_path, index_col=0)
metal_df = pd.read_csv('/Users/jiuy97/bin/tools/tetra/formation_energy.csv', index_col=0)
