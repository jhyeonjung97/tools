...
def extract_info_from_filename(filename):
    ...
    pattern = r'form_pred_([a-z]+)(\d+)_all_result\.log'
...
def main():
    ...
    for filename in os.listdir(root):
        if filename.startswith('form_pred_') and filename.endswith('_all_result.log'):
    ...
    tsv_path = os.path.join(root, 'error_analysis.tsv')
    ...
    csv_path = os.path.join(root, 'error_analysis.csv')
    ...
    ax1.set_xticks([30, 40, 50, 60, 70, 80, 90, 100])
    ax1.set_xticklabels(['0.3', '0.4', '0.5', '0.6', '0.7', '0.8', '0.9', '1.0'])
    ...
    ax2.set_xticks([30, 40, 50, 60, 70, 80, 90, 100])
    ax2.set_xticklabels(['0.3', '0.4', '0.5', '0.6', '0.7', '0.8', '0.9', '1.0'])
    
    # Save plot
    plt.tight_layout()
    plt.savefig(os.path.join(root, 'error_analysis.png'), dpi=300, bbox_inches='tight')
    print(f"Analysis results saved to {os.path.join(root, 'error_analysis.png')}")
