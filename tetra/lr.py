...
def main():
    ...
    parser.add_argument('--Y', required=True, help='Target column from bulk_data.csv')
    parser.add_argument('--X', required=True, nargs='+', help='List of feature columns from bulk_data.csv and/or mendeleev_data.csv')
