...
plt.legend()
plt.text(0.1, 0.1, r'RSS=%.2f, ' % float(risid1) + 'R$^{\sf 2}$ = %.2f' % float(1-risid1/sstot1), transform=plt.gca().transAxes) # Fit statistics
...
plt.legend()
# plt.text(0.1, 0.1, r'RSS=%.2f, ' % (risid2) + 'R$^{\sf 2}$ = %.2f' % (1-risid2/sstot2), transform=plt.gca().transAxes) # Fit statistics
plt.text(0.1, 0.1, r'RSS=%.2f, ' % float(risid1) + 'R$^{\sf 2}$ = %.2f' % float(1 - risid1 / sstot1), transform=plt.gca().transAxes)
...
plt.text(0.1, 0.1, r'RSS=%.2f, ' % float(risid3) + 'R$^{\sf 2}$ = %.2f' % float(1-risid3/sstot3), transform=plt.gca().transAxes) # Fit statistics
